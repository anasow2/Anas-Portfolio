...
export default function FeaturedProject() {
  return (
    <motion.section 
      ...
      className="bg-[#1d1d1f] rounded-3xl p-0 overflow-hidden flex flex-col md:flex-row relative group cursor-pointer w-full flex-1"
    >
      <div className="w-full md:w-1/2 p-10 flex flex-col justify-center z-10">
        ...
        <div className="flex items-center gap-5 mb-5">
          ...
          <h3 className="text-white text-3xl md:text-4xl font-bold tracking-tight">Sahal Marketplace</h3>
        </div>
        ...
        <div className="flex flex-col gap-3 sm:flex-row mt-8 z-20 relative">
          <a href="#" className="flex items-center justify-center px-5 py-2.5 text-sm font-semibold text-white transition-all bg-[#000000] border border-white/10 rounded-xl hover:bg-[#1a1a1c]">
      ...
      <div className="w-full md:w-1/2 relative flex items-center justify-center min-h-[350px] p-6">
        <img 
          src="https://lh3.googleusercontent.com/d/1JgcDJuijsRGjHTmO7zSZQbVSCTqXvUGH" 
          alt="Sahal Marketplace preview"
          className="max-h-[320px] w-auto rounded-2xl shadow-2xl rotate-6 transform md:group-hover:rotate-3 transition-transform duration-700 border-4 border-gray-800"
